...
class app_property_floor_plan
{

    // database connection and table name
    private $conn;
    private $table_name = "app_property_floor_plans";
    ...
    function add_new()
    {
        ...
        //Columns
        $query = $query . " ( property_id, image, image_thumb, sort_order, created_on ) ";

        //Values
        $query = $query . " Values ( :property_id, :image, :image_thumb, :sort_order, now() ) ";
        ...
        $stmt->bindParam(':image_thumb', $this->image_thumb);
