...
class app_property_video
{

    // database connection and table name
    private $conn;
    private $table_name = "app_property_videos";
    ...
    function add_new()
    {
        ...
        //Columns
        $query = $query . " ( property_id, video_link, sort_order, created_on ) ";

        //Values
        $query = $query . " Values ( :property_id, :video_link, :sort_order, now() ) ";
    ...
    function update()
    {
        try {
            ...
            $query = $query . " set video_link = :video_link, sort_order = :sort_order ";
