...
<head>
    ...
    <title>365Homes - Forgot Password</title>
                            ...
                            <form method="post" class="user" id="signup">
                                <div class="form-group row">
                                    <div class="col mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user rounded-0" id="email" name="email" placeholder="Enter email">
                                    </div>
                                </div>
        ...
        (function($) {
            ...
            $.ForgotPassword = function(options) {
                ...
                var init_form = function() {
                    ...
                    var options = {
                        url: 'api/app_users/forgot_password.php',
